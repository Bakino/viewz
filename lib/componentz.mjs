...
export class ViewZElement extends HTMLElement {
    ...
    prepareView(parentView){
        ...
        this.view = new ViewZ({
            html: `${this.componentsDir}/${this.component.name}/${this.component.name}.html`,
            css: `${this.componentsDir}/${this.component.name}/${this.component.name}.css`,
            js: `${this.componentsDir}/${this.component.name}/${this.component.name}.js`,
    ...
    connectedCallback() {
        ...
        if(!this.view){
            //view not yet init
            let parentView = null ;
            const parentContainer = this.closest("[z-view-container]") ;
            if(parentContainer){
                parentView = parentContainer.contextz.view ;
            }
            if(!parentView){
                //not yet inside a view, stop
                return ;
            }
            this.prepareView(parentView) ;
        }
        this.rendering = true;
