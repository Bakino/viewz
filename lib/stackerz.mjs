...
class Stacker {
    ...
    getContainer({parentContainer}){       
        ...
        stackContainer.className = `viewz-stack-container viewz-stack-${this.className} ${this.params.class??''}` ;
...
class StackerInPlace {
    ...
    getContainer({parentContainer, route, level}){       
        if(!route.parent){
        ...
        this.container.setAttribute("level", level) ;
